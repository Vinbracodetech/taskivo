...
export function Terms() {
  return (
    <div style={S.page}>
      <div style={{ fontSize: 12, fontWeight: 700, color: 'var(--slate)', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: 12 }}>Last Updated: May 2026</div>
...
export function Privacy() {
  return (
    <div style={S.page}>
      ...
      <p style={S.p}>Banking information provided for withdrawal routing is encrypted and utilized solely for payment processing. We do not sell user telemetry to third-party brokers.</p>
    </div>
  );
}
