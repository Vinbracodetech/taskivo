...
export default function History({ session }) {
  ...
  const S = {
    ...
    tabWrap: { display: 'flex', gap: 8, marginBottom: 40, background: 'var(--surface-card)', padding: 6, borderRadius: 100, border: '1px solid rgba(255,255,255,0.05)', width: 'fit-content', flexWrap: 'wrap', boxShadow: '0 4px 20px rgba(0,0,0,0.1)' },
    tab: (isActive) => ({
  ...
  return (
    <div style={S.page}>
      ...
      {loading ? (
        ...
        <div style={{ textAlign: 'center', padding: '80px', background: 'var(--surface-card)', border: '1px solid rgba(255,255,255,0.05)', borderRadius: 24, color: 'var(--slate)' }}>
