...
export default function Landing({ navigate, setAuthMode }) {
  ...
  // 🔥 UPDATED: Removed Explicit Timers - Focused on "High Retention" 🔥
  const socialPricing = [
    { name: 'Pilot Views', price: '$2', slots: 40, features: ['Verified Human Views', 'Algorithm Safe', 'Anti-Cheat Network'] },
    { name: 'Basic Views', price: '$5', slots: 105, features: ['Verified Human Views', 'Algorithm Safe', 'Anti-Cheat Network'] },
    { name: 'Starter Views', price: '$12', slots: 260, features: ['Verified Human Views', 'Algorithm Safe', 'Global Distribution'] },
    { name: 'Traction Views', price: '$25', slots: 550, features: ['Verified Human Views', 'Algorithm Safe', 'Priority Routing'], isPopular: true },
    { name: 'Scale Views', price: '$50', slots: 1120, features: ['Volume Discount', 'High Retention Rate', 'Priority Routing'] },
  ];

  const growthPricing = [
    { name: 'Pilot Growth', price: '$3', slots: 40, features: ['Real Human Accounts', 'Permanent Subs/Follows'] },
    { name: 'Basic Growth', price: '$7', slots: 95, features: ['Real Human Accounts', 'Permanent Subs/Follows'] },
    { name: 'Starter Growth', price: '$15', slots: 210, features: ['Real Human Accounts', 'Permanent Subs/Follows', 'Zero Bot Drops'] },
    { name: 'Traction Growth', price: '$30', slots: 430, features: ['Real Human Accounts', 'Permanent Subs/Follows', 'Priority Placement'], isPopular: true },
    { name: 'Scale Growth', price: '$60', slots: 880, features: ['Real Human Accounts', 'Permanent Subs/Follows', 'Maximum Velocity'] },
  ];
  ...
  const seoPricing = [
    ...
    { name: 'Starter Traffic', price: '$14', slots: 240, features: ['Standard Web Routing', 'Human Navigators', 'Guaranteed Engagement'] },
    { name: 'Traction Traffic', price: '$28', slots: 500, features: ['Standard Web Routing', 'Priority Routing', 'Guaranteed Engagement'], isPopular: true },
    { name: 'Scale Traffic', price: '$55', slots: 1000, features: ['Volume Discount', 'Maximum Velocity', 'Guaranteed Engagement'] },
  ];

  const adsensePricing = [
    { name: 'Pilot Arbitrage', price: '$3.50', slots: 45, features: ['High Retention Traffic', 'Ad-Interaction Ready'] },
    { name: 'Basic Arbitrage', price: '$8', slots: 105, features: ['High Retention Traffic', 'Ad-Interaction Ready'] },
    { name: 'Starter Arbitrage', price: '$18', slots: 240, features: ['High Retention Traffic', 'Ad-Interaction Ready', 'Account Protection'] },
    { name: 'Traction Arbitrage', price: '$38', slots: 510, features: ['High Retention Traffic', 'Ad-Interaction Ready', 'Premium Routing'], isPopular: true },
    { name: 'Scale Arbitrage', price: '$75', slots: 1020, features: ['High Retention Traffic', 'Volume Injection', 'Maximum Velocity'] },
  ];
  ...
  const serviceDetails = {
    social: { title: 'YouTube & Social Views', icon: '▶️', desc: 'Boost algorithmic reach. Real humans watch and engage with your content. Every view is verified by our anti-cheat network to ensure zero drop-offs and high retention.' },
    growth: { title: 'Audience Growth (Subs & Follows)', icon: '👥', desc: 'Build a permanent follower base. To prevent algorithms from flagging spam, our earners provide quality engagement with your content before hitting subscribe or follow.' },
    ...
    adsense: { title: 'AdSense & Arbitrage Traffic', icon: '💰', desc: 'High-tier traffic specifically engineered for AdSense Arbitrage. High retention dwell times and ad-interaction compliance to keep your Google ad accounts perfectly healthy.' },
  ...
  const faqs = [
    ...
    { q: 'What is the difference between Standard SEO and AdSense Arbitrage tasks?', a: 'Standard SEO tasks (30 PTS) focus on search visibility. AdSense Arbitrage tasks reward earners with higher pay (40 PTS) because they require high-retention dwell times and ad-interaction compliance to protect the Creator’s Google AdSense account health.' },
    { q: 'How does the Audience Growth package guarantee permanent subscribers?', a: 'If a user just clicks "Subscribe" without engaging, platforms delete it as spam. Our system ensures Earners interact with your content organically before subscribing. This costs slightly more, but guarantees permanent, algorithm-friendly followers.' },
          ...
          <div style={{ background: C.white, border: `1px solid ${C.line}`, borderRadius: 16, overflow: 'hidden' }}>
            ...
            <div style={{ padding: 40 }}>
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: '0 0 32px 0', display: 'flex', flexDirection: 'column', gap: 16 }}>
                ...
                <li style={{ display: 'flex', alignItems: 'center', gap: 12, color: C.slate, fontSize: 15 }}><span style={{ color: C.ink, fontWeight: 'bold' }}>✓</span> Grow permanent, algorithm-safe audiences</li>
